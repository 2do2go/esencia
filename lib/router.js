...
(function (root, factory) {
	...
	Router.navigate = function(fragment, options) {
		...
		if (options.force) {
			...
			return this.navigate(fragment, _(options).omit('force'));
		}
	...
	Router.setModule = function(params) {
		...
		// Using just params if opened directly html file (not on server).
		// On server using params.url.
		var url = params.url || params;
		delete params.url;
